...
import type { NextRequest } from "next/server"; // [+] IMPORTADO: Tipo nativo do Next.js para a requisição

export function middleware(request: NextRequest) { // [+] ADICIONADO: Tipagem do parâmetro
